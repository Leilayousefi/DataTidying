...
install.packages(c("devtools", "roxygen2", "testthat", "tidyverse", "knitr", "tidyr", "dplyr", "ggplot2", "stringr", "xltabr"))
...
#what’s the difference between unit testing and ttd?
...
# however, visualTest wasn’t failing when it should of been (detected with TDD)
...
Namespaces accessed by the ‘::’ and ‘:::’ operators must be listed here, or in ‘Suggests’ or ‘Enhances’
...
# practice makes perfect, here’s a toy example which is useful if your new to RMarkdown
...
## ......................................... ##
## Create website using Travis_CI
Creating a website for your R package
...
## AI Decision Tool 
https://github.com/mammykins/Goldilocks-decision-tool
...
# look at some of Hadley’s tests here (or use a package you are familiar with)
...
library(rmarkdown)
```
https://machinegurning.com/rstats/latex-phd/
...
https://user-guidance.services.alpha.mojanalytics.xyz/#moj-analytical-platform
